      ...
      items: [
        {
          ...
          github: 'https://github.com/kayyonly/personal-web',
          demo: 'https://kayydeveloper.netlify.app/'
        },
        {
          id: 2,
        ...
        },
        {
          ...
          imageUrl: 'bumdesma',
          status: 'memory game card, which is useful for training our memorization.',
          tech: 'Html, Css, Javascript',
          github: 'https://github.com/Kayyonly/Game',
          demo: 'https://kayyonly.github.io/Game/'
        },
        {
          id: 5,
          name: 'SP2SE',
